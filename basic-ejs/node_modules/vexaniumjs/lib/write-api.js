...
var _require = require('vexjs-api'),
...
function WriteApi(Network, network, config, Transaction) {
  ...
  */
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 34:
              ...
              cachedCode = new Set(['vexcore', 'vex.token', 'vex.null']);
  ...
  function genMethod(type, definition, transactionArg) {
    var account = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 'vex.token';
          ...
          case 25:
            ...
            for (_i = 0; _i < _arr.length; _i++) {
              ...
              if (arg[txField] !== undefined) {
                // eos.transaction('vexcore', eosio => { eosio.myaction(..) }, {delay_sec: 369})
